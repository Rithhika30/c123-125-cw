...
function setup(){
    video = createCapture(VIDEO); // accessing live camera
    video.size(550,500);

    canvas= createCanvas(550,550);
    canvas.position(560,150);

    poseNet= ml5.poseNet(video, modelLoaded); //initialising poseNet model. here the model is applied on the live webcam view
